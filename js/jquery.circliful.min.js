    ...
    $.fn.circliful = function (options, callback) {
        ...
        return this.each(function () {
            ...
            if(settings.targetPercent > 0) {
                ...
                elements += '<text text-anchor="middle" x="' + textX + '" y="90" style="font-size: ' + settings.targetTextSize + 'px;" fill="' + settings.targetColor + '">' + settings.targetPercent + '%</text>';
            ...
            if(settings.text != null && settings.multiPercentage == 0) {
                elements += '<text text-anchor="middle" x="100" y="105" style="' + settings.textStyle + '" fill="' + settings.textColor + '">' + settings.text + '</text>';
